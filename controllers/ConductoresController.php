...
class ConductoresController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                if( is_array( Yii::$app->request->post()['Conductores']['dispositivos'] ) ){
                    DispositivosConductores::deleteAll('conductor_id = '.$model->id);
                    foreach ( Yii::$app->request->post()['Conductores']['dispositivos'] as $pc ) {
                        $p = new DispositivosConductores();
                        $p->dispositivo_id = $pc;
                        $p->conductor_id = $model->id;
                        $p->save();
                    }
                }
                return [
                    ...
                    'title'=> "Crear nuevo Conductores",
                    'content'=>'<span class="text-success">Create Conductores success</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Conductores #".$id,
    ...
    /**
     * Delete an existing Conductores model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Conductores model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
