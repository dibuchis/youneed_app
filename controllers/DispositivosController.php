...
class DispositivosController extends Controller
{
    ...
    {    
        ...
        $dataProvider = $searchModel->dispositivosgps(Yii::$app->request->queryParams);
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nuevo Dispositivos",
                ...
                return [
                    ...
                    'title'=> "Crear nuevo Dispositivos",
                    'content'=>'<span class="text-success">Create Dispositivos success</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualizar Dispositivos #".$id,
                ...
                $response = Traccar::setDevice( $model, 'PUT', $model->traccar_id );
                $model->traccar_id = $response['id'];
                $model->save();
                return [
                    'forceReload'=>'#crud-datatable-pjax',
    ...
    /**
     * Delete an existing Dispositivos model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
        $request = Yii::$app->request;
        $model = $this->findModel($id);
        $response = Traccar::deleteDevice( $model->traccar_id );
     ...
     /**
     * Delete multiple existing Dispositivos model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
