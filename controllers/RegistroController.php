            ...
            if($request->isAjax){
                ...
                if( $model->save() ){
                    ...
                    try{
                        ...
                        ->setTo($model->email)
                        ->setSubject("YouNeed - Registro exitoso")
                        ->setHtmlBody('<div style="background:#2e8a96; margin:0px auto; max-width:650px; height:80px; padding:8px;color:white;"> <img src="https://app.youneed.com.ec/images/logo-admin.png" style="width:120px; height:auto;margin:12px 25px 12px 12px"></div> <div style="padding:25px;"> <h2 style="font-family:Arial, Helvetica, sans-serif; color:#117c8f;">' . $model->nombres . ',</h2> <h3 style="font-family:Arial, Helvetica, sans-serif; color:#117c8f;">¡Bienvenido a YouNeed!</h3> </div> <div style="margin:25px auto; max-width:650px;"> <p style="font-family:Arial, Helvetica, sans-serif; color:#9a999e;">Estimado Asociado, </p> <p style="font-family:Arial, Helvetica, sans-serif; color:#9a999e;">Gracias por unirte a la mayor red de profesionales y clientes que están usando YouNeed para ofrecer sus servicios, nuestro compromiso es brindarte las mejores herramientas para que canalices tu talento hacia la comunidad y obtengas los beneficios que siempre quisiste.</p> <p style="font-family:Arial, Helvetica, sans-serif; color:#9a999e;">Por favor, ingresa a tu perfil para ver los datos y documentos: </p> <p><a style="background-color: #178b89!important; border-color: #178b89!important; line-height: 1.42857143; text-align: center; white-space: nowrap; font-size: 14px; padding: 6px 12px; color: #fff; margin: 35px auto 10px; width: 180px; display: block;" href="https://app.youneed.com.ec">Perfil de Asociado</a> </p> </div> </div> <div style="font-family:Arial, Helvetica, sans-serif; height:40px; margin-top:25px;background:#9a999e; text-align:center; padding:7px; padding-top:15px; color:#fff;">YouNeed® Todos los derechos reservados.</div>', 'text/html')
                        ->send();
